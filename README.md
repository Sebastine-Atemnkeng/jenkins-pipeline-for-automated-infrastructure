...
## CICD Infra setup
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated-infra" (https://github.com/sebastine01/jenkins-pipeline-for-automated-infrastructure)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "devops-fully-automated-infra" (https://github.com/sebastine01/jenkins-pipeline-for-automated-infrastructure) & name it "jenkins-pipeline-for-automated-infrastructure"**
...
2) ###### Jenkins
    ...
    - User data (Copy the following user data): https://github.com/sebastine01/jenkins-pipeline-for-automated-infrastructure/blob/jenkins-maven-ansible-installation.sh/installations.sh
    - Launch Instance
...
## Now observe the enitre pipeline flow and try to understand the integrations :) 
# Happy learning 😊
